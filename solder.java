...
public class solder extends Frinds{

    @Override
    void attacked(int peat) {
        super.attacked(peat); //To change body of generated methods, choose Tools | Templates.
    }
    ...
    public int getDargetTa7mol() {
        return super.getDargetTa7mol(); //To change body of generated methods, choose Tools | Templates.
    }

    @Override
    public void setDargetTa7mol(int dargetTa7mol) {
        super.setDargetTa7mol(dargetTa7mol); //To change body of generated methods, choose Tools | Templates.
    }
